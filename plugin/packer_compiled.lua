...
_G.packer_plugins = {
  ...
  ["everforest-nvim"] = {
    loaded = true,
    path = "/Users/kojimagai/.local/share/nvim/site/pack/packer/start/everforest-nvim",
  ...
  ["lspsaga.nvim"] = {
    ...
    loaded = true,
    needs_bufread = false,
    path = "/Users/kojimagai/.local/share/nvim/site/pack/packer/opt/lspsaga.nvim",
  ...
  ["vim-visual-multi"] = {
    loaded = true,
    path = "/Users/kojimagai/.local/share/nvim/site/pack/packer/start/vim-visual-multi",
